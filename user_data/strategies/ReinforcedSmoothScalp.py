...
class ReinforcedSmoothScalp(IStrategy):
    ...
    buy_adx = IntParameter(20, 50, default=36, space='buy')
    buy_fastd = IntParameter(15, 45, default=17, space='buy')
    buy_fastk = IntParameter(15, 45, default=42, space='buy')
    buy_mfi = IntParameter(10, 25, default=21, space='buy')
    buy_adx_enabled = BooleanParameter(default=False, space='buy')
    buy_fastd_enabled = BooleanParameter(default=False, space='buy')
    buy_fastk_enabled = BooleanParameter(default=True, space='buy')
    buy_mfi_enabled = BooleanParameter(default=True, space='buy')

    sell_adx = IntParameter(50, 100, default=53, space='sell')
    sell_cci = IntParameter(100, 200, default=190, space='sell')
    sell_fastd = IntParameter(50, 100, default=63, space='sell')
    sell_fastk = IntParameter(50, 100, default=88, space='sell')
    sell_mfi = IntParameter(75, 100, default=86, space='sell')

    sell_adx_enabled = BooleanParameter(default=False, space='sell')
    sell_cci_enabled = BooleanParameter(default=True, space='sell')
    sell_fastd_enabled = BooleanParameter(default=False, space='sell')
    sell_fastk_enabled = BooleanParameter(default=False, space='sell')
